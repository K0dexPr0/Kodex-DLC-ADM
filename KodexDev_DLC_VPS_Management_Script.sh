...
banner() {
  ...
  echo "║                Joel_DLC                    ║"
  echo "╠════════════════════════════════════════════╣"
  echo -e "║ OS      : ${WHITE}$OS${CYAN}"
  echo -e "║ Kernel  : ${WHITE}$KERNEL${CYAN}"
  echo -e "║ RAM     : ${WHITE}${RAM}MB${CYAN}"
  echo -e "║ CPU     : ${WHITE}$CPU${CYAN}"
  echo -e "║ IP      : ${WHITE}$IP${CYAN}"
  echo -e "║ Uptime  : ${WHITE}$UPTIME${CYAN}"
  echo "╚════════════════════════════════════════════╝"
  echo -e "${NC}"
}
